...
// code for adding the game background
	this.add.sprite(0, 0, 'Level2Background');
...
//code for the Middle and top Section of the game platforms 
    var ledge = this.game.platforms.create(775, 100, 'platformtop');
		ledge.body.immovable = true;
    ledge = this.game.platforms.create(310, 200, 'platformtopleft');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(460, 200, 'platformtopmiddle');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(610, 200, 'platformtopright');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(950, 200, 'platformtopleft');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(1100, 200, 'platformtopmiddle');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(1250, 200, 'platformtopright');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(0, 350, 'platformtopleft');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(150, 350, 'platformtopright');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(1400, 350, 'platformtopleft');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(1550, 350, 'platformtopright');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(625, 500, 'platformtopleft');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(775, 500, 'platformtopmiddle');
		ledge.body.immovable = true;
	ledge = this.game.platforms.create(925, 500, 'platformtopright');
		ledge.body.immovable = true;
	var ledge = this.game.platforms.create(500, 500, 'platformtop');
		ledge.body.immovable = true;
	var ledge = this.game.platforms.create(371, 500, 'platformtop');
		ledge.body.immovable = true;
	var ledge = this.game.platforms.create(1050, 500, 'platformtop');
		ledge.body.immovable = true;
	var ledge = this.game.platforms.create(1179, 500, 'platformtop');
		ledge.body.immovable = true;
	var ledge = this.game.platforms.create(230, 620, 'platformtop');
		ledge.body.immovable = true;
	var ledge = this.game.platforms.create(1310, 620, 'platformtop');
		ledge.body.immovable = true;
...
// code for creating the finish flag
		Flag = this.game.add.sprite(840, 0, 'Flag');
...
// code for adding The Game Text for the crowns and the level name  
	...
	var levelname = this.game.add.text(820, 15, 'LEVEL 2 - THE DISCOVERY', { fontSize: '32px', fill: '#71706e' });
...
// code for setting up of the score automatic win after 19 have been collected
		if (score == 19)
		{
			this.state.start('NextLevel3Menu');
		}
...
// code for loading the looser menu after player Death and stopping music 
	...
	{
		music.stop();
   	this.state.start('LooserMenuLevel2');
	},
