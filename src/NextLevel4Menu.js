BasicGame.NextLevel4Menu = function (game) { };

BasicGame.NextLevel4Menu.prototype = {
...
// code for the page title 
		otherText = this.game.add.text(480, 360, 'WELCOME TO THE PECULIAR GALAXY', { fontSize: '40px', fill: '#d7be69' });
// code for the button text   
		otherText = this.game.add.text(575, 700, 'CLICK ON THE BUTTON TO START LEVEL 4', { fontSize: '25px', fill: '#aaa9ad' });
// code for the buttton
		button = this.game.add.button(750, 760, 'nextlevelbutton', this.startGame, this, 2, 1);
		button = this.game.add.button(50, 48, 'level4button', this.donothing, this, 2, 1);
		button = this.game.add.button(1450, 48, 'level4button', this.donothing, this, 2, 1);
	},
